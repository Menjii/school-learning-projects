...
public class PaymentController {
    ...
    //get address
    @GetMapping("payment")
    public List<PaymentDataDto> getAllPayments() {
        return this.paymentRepository.findAll();
    }

    //get address by id
    @GetMapping("/payment/{id}")
    public ResponseEntity<PaymentDataDto> getPaymentById(@PathVariable(value = "id") int paymentId)
    ...
    //save address
    @PostMapping("/payment")
    public PaymentDataDto createPayment(@RequestBody PaymentDataDto platnoscIdentity) {
        return this.paymentRepository.save(platnoscIdentity);
    }

    //update address
    @PutMapping("platnosc/{id}")
    public ResponseEntity<PaymentDataDto> updatePayment(@RequestBody PaymentDataDto payment) {
    ...
    public Map<String, Boolean> deletePayment(@PathVariable(value = "id") int paymentId) throws ResourceNotFoundException {
