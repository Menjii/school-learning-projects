...
public class WorkerController {
    ...
    public ResponseEntity<WorkerDto> getWorkerById(@PathVariable(value = "id") int workerId)
    ...
    public ResponseEntity<WorkerDto> updateWorker(@RequestBody WorkerDto worker) {
    ...
    public Map<String, Boolean> deleteWorker(@PathVariable(value = "id") int workerId) throws ResourceNotFoundException {
