...
public class OrderRateController {
    ...
    public List<OrderRateDto> getAllOrderRate() {
        return this.orderRateRepository.findAll();
    }

    //get address by id
    @GetMapping("/order-rate/{id}")
    public ResponseEntity<OrderRateDto> getOrderRateById(@PathVariable(value = "id") int orderRateId)
    ...
    public OrderRateDto createOrderRate(@RequestBody OrderRateDto orderRateDto) {
        return this.orderRateRepository.save(orderRateDto);
    }

    //update address
    @PutMapping("/order-rate/{id}")
    public ResponseEntity<OrderRateDto> updateOrderRate(@RequestBody OrderRateDto orderRate) throws ResourceNotFoundException {
    ...
    public Map<String, Boolean> deleteOrderRate(@PathVariable(value = "id") int orderRateId) throws ResourceNotFoundException {
