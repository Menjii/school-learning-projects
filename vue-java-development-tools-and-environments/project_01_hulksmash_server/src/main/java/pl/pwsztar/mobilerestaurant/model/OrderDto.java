...
public class OrderDto {
  ...
  public OrderDto(OrderDto order) {
    ...
    this.realizationStatus = order.getRealizationStatus();
    this.comments = order.getComments();
  }

  public OrderDto(int id, WorkerDto worker, User client, OrderRateDto rate, PaymentDataDto paymentData, String realizationStatus, String comments) {
    this.id = id;
    this.worker = worker;
    this.client = client;
    this.rate = rate;
